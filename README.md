...
In the spirit of fun (and because this is a worthless script with no real value) the -o switch 
is used when generating our fortunes. If this offends you please remove the -o switch before 
running this script!!!

For more offensive fortunes please install fortunes-off in addition to fortune-mod
